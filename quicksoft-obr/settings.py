"""
Django settings for quicksoft-obr project.
...
SECRET_KEY = 'django-insecure-ok+4c^uw7m$9q^%)u5*oeoyzq9w30us+q1nyvqby_do$mn2z$u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.88.111',]
...
ROOT_URLCONF = 'quicksoft-obr.urls'
...
WSGI_APPLICATION = 'quicksoft-obr.wsgi.application'
